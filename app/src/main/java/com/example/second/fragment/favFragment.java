package com.example.second.fragment;
...
import com.example.second.Model.Recmodel;
import com.example.second.R;
import com.example.second.Recadapter.Favadapter;
import com.example.second.sqlite.dbhandler;
...
RecyclerView recyclerView;
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        MenuItem menuItem2= menu.findItem(R.id.search_bar);
        androidx.appcompat.widget.SearchView fedit= (androidx.appcompat.widget.SearchView) menuItem2.getActionView();
